...
namespace PlasticSYS.Controllers
{
    ...
    public class VentasController : Controller
    {
        ...
        {
            var plasticSysContext = _context.Ventas.Include(v => v.Cliente).Include(v => v.Producto);
        ...
        public async Task<IActionResult> Create([Bind("VentaId,FechaVenta,Total,ClienteId,ProductoId")] Venta venta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VentaId,FechaVenta,Total,ClienteId,ProductoId")] Venta venta)
        {
            if (id != venta.VentaId)
            {
                return NotFound();
